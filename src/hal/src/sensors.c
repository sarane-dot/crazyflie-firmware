...
#if defined(CONFIG_SENSORS_BMI088_BMP3XX) && !defined(CONFIG_PLATFORM_SITL)
  {
...
#endif
#if defined(CONFIG_SENSORS_BMI088_SPI) && !defined(CONFIG_PLATFORM_SITL)
  {
...
#endif
#if defined(CONFIG_SENSORS_MPU9250_LPS25H) && !defined(CONFIG_PLATFORM_SITL)
  {
...
#endif
#if defined(CONFIG_SENSORS_BOSCH) && !defined(CONFIG_PLATFORM_SITL)
  {
